...
export default function SignupPage() {
  return (
    <main className="relative min-h-screen bg-linear-to-br dark:from-zinc-900 dark:via-neutral-900 dark:to-black text-white">
      <Link
        href="/"
          ...
          <div className="lg:col-span-5 flex items-center justify-center">
            <div className="w-full max-w-md">
              ...
              <p className="mt-6 text-center text-sm text-slate-600 dark:text-zinc-400">
                ...
                <Link href="/login" className="font-semibold text-indigo-500 underline">
                  Sign in
                </Link>
              </p>
            </div>
