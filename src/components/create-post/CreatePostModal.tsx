      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl border border-white/20 bg-black/80 shadow-2xl shadow-black/40 backdrop-blur-xl"
          >
            {/* Header */}
            <div className="sticky top-0 z-10 border-b border-white/10 bg-black/60 backdrop-blur px-6 py-4 flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold text-white">Create a Post</h2>
                <p className="text-xs text-zinc-400 mt-1">Share what's on your mind</p>
              </div>
              <motion.button
                onClick={onClose}
