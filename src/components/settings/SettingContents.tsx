              ...
              <div>
                ...
                <SectionCard title="Profile details">
                  <div className="grid gap-4 md:grid-cols-2">
                    <TextField label="Display name" defaultValue={currentUser.displayName} />
                    <TextField label="Username" defaultValue={currentUser.username} />
                    <TextField label="Email" type="email" defaultValue={currentUser.email} />
                    <TextField label="Website" placeholder="https://" />
                  </div>
                  <div className="mt-4">
                    <TextField label="Bio" defaultValue={currentUser.bio} placeholder="Tell people about yourself" />
                  </div>
