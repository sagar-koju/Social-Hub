...
export function MessagesClient() {
    ...
    return (
        <motion.main
            ...
            className="relative min-h-screen overflow-hidden bg-[#030313] text-white"
        >
            ...
            <div className="mx-auto flex min-h-screen w-full max-w-400 flex-col px-4 py-6 sm:px-6 lg:px-8">
                <div className="grid min-h-0 flex-1 gap-4 md:grid-cols-[320px_minmax(0,1fr)] lg:grid-cols-[320px_minmax(0,1fr)] xl:grid-cols-[320px_minmax(0,1fr)_320px]">
                    <div className="sticky top-6 hidden h-[calc(100dvh-7.5rem)] md:block">
                        <ChatSidebar
                    ...
                    <div className="sticky top-6 hidden h-[calc(100dvh-7.5rem)] xl:block">
